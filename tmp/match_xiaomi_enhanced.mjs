...
async function runMatching() {
    ...
    const localXiaomi = await Product.find({
        category: { $in: ['xiaomi', 'redmi', 'poco', 'smart-home', 'aspiradoras-robot', 'xiaomi-home', 'camaras-seguridad', 'xiaomi-watches'] }
    }).lean();

    const translations = {
        'preto': 'black', 'negro': 'black',
        'branco': 'white', 'blanco': 'white',
        'verde': 'green',
        'azul': 'blue',
        'prata': 'silver', 'plata': 'silver',
        'gris': 'gray', 'grey': 'gray',
        'ouro': 'gold', 'dourado': 'gold',
        'purpura': 'purple', 'morado': 'purple', 'roxo': 'purple',
        'rojo': 'red', 'vermelho': 'red',
        'amarillo': 'yellow'
    };
    ...
    console.log('--- ENHANCED MATCHING SUMMARY ---');
    ...
    fs.writeFileSync('c:\\Users\\Juli\\Desktop\\JBimports-JS\\jbimportsWEBNextJS\\tmp\\xiaomi_matching_enhanced.json', JSON.stringify(results, null, 2));
